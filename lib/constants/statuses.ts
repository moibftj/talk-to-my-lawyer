...
export type LetterStatus =
  (typeof LETTER_STATUSES)[keyof typeof LETTER_STATUSES];
...
export const VALID_LETTER_TRANSITIONS: Record<LetterStatus, LetterStatus[]> = {
  ...
  [LETTER_STATUSES.FAILED]: [LETTER_STATUSES.DRAFT], // Allow retry from failed
};
...
export type DeletionStatus =
  (typeof DELETION_STATUSES)[keyof typeof DELETION_STATUSES];
...
export type EmailQueueStatus =
  (typeof EMAIL_QUEUE_STATUSES)[keyof typeof EMAIL_QUEUE_STATUSES];
