...
export const RATE_LIMITS = {
  ...
  LETTER_GENERATE: {
    limit: 5,
    window: "1 m",
    description: "Letter generation requests",
  },
  LETTER_IMPROVE: {
    limit: 10,
    window: "1 m",
    description: "Letter improvement requests",
  },
  LETTER_SUBMIT: {
    limit: 10,
    window: "1 m",
    description: "Letter submissions",
  },
  ...
  BILLING_HISTORY: {
    limit: 30,
    window: "1 m",
    description: "Billing history requests",
  },
  ...
  ADMIN_READ: {
    limit: 100,
    window: "1 m",
    description: "Admin read operations",
  },
  ADMIN_WRITE: {
    limit: 50,
    window: "1 m",
    description: "Admin write operations",
  },
  ADMIN_BULK: {
    limit: 10,
    window: "1 m",
  ...
  EMPLOYEE_READ: {
    limit: 50,
    window: "1 m",
    description: "Employee read operations",
  },
  EMPLOYEE_WRITE: {
    limit: 20,
    window: "1 m",
    description: "Employee write operations",
  },
  ...
  API_READ: {
    limit: 200,
    window: "1 m",
    description: "Read-only API requests",
  },
