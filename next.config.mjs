          ...
          value:
            process.env.NODE_ENV === "production"
              ? [
                  ...
                  "connect-src 'self' https://api.stripe.com https://js.stripe.com https://*.supabase.co https://app.talk-to-my-lawyer.com https://vercel.live https://resend.com wss: wss://*.vercel.run wss://*.vusercontent.net ws:;",
              ...
              : [
                  ...
                  "font-src 'self' https://fonts.gstatic.com https://vercel.live;",
                  "img-src 'self' data: https: blob:;",
                  "connect-src 'self' https://api.stripe.com https://js.stripe.com https://*.supabase.co https://app.talk-to-my-lawyer.com https://vercel.live https://resend.com ws: wss: ws://localhost:* ws://127.0.0.1:* wss://localhost:* wss://127.0.0.1:* wss://*.vercel.run wss://*.vusercontent.net;",
                  "img-src 'self' data: https: blob: https://www.transparenttextures.com;",
                  "frame-src 'self' https://js.stripe.com https://vercel.live;",
                  "frame-ancestors *;",
                  "base-uri 'self';",
