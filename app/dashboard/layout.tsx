...
export default function DashboardLayout({
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-spin rounded-full h-40 w-40 border-b-2 border-primary"></div>
      </div>
    )
  }
  ...
  const navigation = [
    ...
    { name: 'Referrals', href: '/dashboard/referrals', icon: Users, roles: ['employee'] },
    { name: 'Payouts', href: '/dashboard/payouts', icon: CreditCard, roles: ['employee'] },
          ...
          <div className="flex h-16 shrink-0 items-center">
            <Link href="/dashboard" className="flex items-center gap-2">
              <Image
                ...
                width={48}
                height={48}
                className="h-12 w-12 rounded-full logo-badge"
                priority
              />
